...
public class Actions {
	...
	public Boolean isTheLinkBrokenForbidden(URL url) {
		int statusCode = 0;
		...
		// starting with 200 is success and start with 300 is redirect
		if (statusCode >= 400) {
			return true;
		} else {
			return false;
	...
	// check if the link is Redirecting
	public Boolean isTheLinkRedirect(URL url) {
		int statusCode = 0;
